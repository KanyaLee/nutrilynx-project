...
import LocationOnOutlinedIcon from '@mui/icons-material/LocationOnOutlined';import AccountCircleIcon from '@mui/icons-material/AccountCircle';
  ...
  return (
    <nav className={styles.navbar}>
        ...
        <div className={styles.icons}>
            <Link href="/locations"><LocationOnOutlinedIcon /></Link>
